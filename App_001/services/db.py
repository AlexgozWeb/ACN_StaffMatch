...
def get_promotion_requests():      return _load("promotion_requests.json")
def get_project_change_requests(): return _load("project_change_requests.json")

def save_skills(data):              _save("skills.json", data)
def save_roles(data):               _save("roles.json", data)
def save_resources(data):           _save("resources.json", data)
def save_projects(data):            _save("projects.json", data)
def save_allocations(data):         _save("allocations.json", data)
...
def save_promotion_requests(data):        _save("promotion_requests.json", data)
def save_project_change_requests(data):   _save("project_change_requests.json", data)
